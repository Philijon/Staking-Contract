...
contract("Stakercontract",async()=>{
    ...
    it("test the stakedSince, stakedAmount, tokenStakedBy and getRewardRate function",async()=>{
        ...
        await web3.eth.sendTransaction({to: address2, from:address1, value: web3.utils.toWei(`2`,`ether`)});
        await web3.eth.sendTransaction({to: address1, from:address2, value: web3.utils.toWei(`2`,`ether`)});
